...
SYSTEM_ROLES = {
    ...
    Con cada respuesta no repitas ni reconfirmes, pasa a la siguiente pregunta o recomendación directamente.
    No abrumes con muchas preguntas a la vez, recoge la información necesaria de forma fluida, natural breve y concisa.
